...
const Herosection = () => {
  return (
    <section className='text-animated min-h-screen flex flex-col justify-center items-center gap-4'>
        ...
        <div className='title md:text-2xl text-[calc((0.8*1.5rem)] '>
            Hi, Everyone
        </div>
        <div className='description  mb-10 md:text-[5.5rem] text-[calc(0.5*5.5rem)] font-bold max-w-5xl text-center'>
