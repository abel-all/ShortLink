...
const SettingsPage = () => {
  ...
  const handlePersonalInfoSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Sending personal info to backend:', personalInfo);
      setSuccess('personal');
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      setSuccess('delete');
      // In real app, redirect to login or homepage
      setTimeout(() => {
        setSuccess(null);
  ...
  return (
      <div className="max-w-4xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 sm:p-8 mb-6">
          <div className="flex items-center gap-3 mb-6">
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4 sm:space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-colors"
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-amber-600 hover:bg-amber-700 disabled:bg-amber-400 text-white rounded-lg font-medium transition-colors duration-200"
            >
              {loading === 'password' ? (
                <>
                  <Loader2 className="h-4 w-4 animate-spin" />
        ...
        <section className="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-900/50 rounded-xl p-6 sm:p-8">
          ...
          {!showDeleteConfirm ? (
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium transition-colors duration-200"
            >
            ...
            <div className="space-y-4">
              <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-red-300 dark:border-red-800">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white rounded-lg font-medium transition-colors duration-200"
                  >
                    {loading === 'delete' ? (
                      <>
                        <Loader2 className="h-4 w-4 animate-spin" />
                  ...
                  <button
                    ...
                    disabled={loading === 'delete'}
                    className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-lg font-medium transition-colors duration-200"
                  >
                    Cancel
                  </button>
                </div>
